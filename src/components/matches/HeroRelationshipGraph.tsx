...
import { ChevronLeft, Camera, Filter, ChevronDown, ChevronUp, Globe, Users, Loader2, Network, Info } from 'lucide-react';
...
const HeroRelationshipGraph: React.FC<HeroRelationshipGraphProps> = ({ onBack, initialStatsMode = 'local' }) => {
  ...
  const handleTakeScreenshot = async () => {
    ...
    try {
      ...
      link.download = `hero-relationship-network-${new Date().toISOString().slice(0, 10)}.png`;
      link.href = dataUrl;
      link.click();
